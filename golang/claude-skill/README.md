...
cp -R golang/claude-skill/skills/thor-validate /path/to/your/project/.claude/skills/
```
...
If you're iterating on Thor itself, open the `golang/` directory in
Claude Code directly. The whole `.claude/skills` directory is a single
